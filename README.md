...
[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-frontier-qwen3-235b-a22b-instruct) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-frontier-qwen3-235b-a22b-instruct` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-frontier-qwen3-235b-a22b-instruct --local-dir lumynax-frontier-qwen3-235b-a22b-instruct
cd lumynax-frontier-qwen3-235b-a22b-instruct && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-frontier-qwen3-235b-a22b-instruct -i
```
